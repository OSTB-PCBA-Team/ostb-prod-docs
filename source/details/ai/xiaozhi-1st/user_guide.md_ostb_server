...
短按2S开机键将设备开机，启动完成之后会提示连接设备创建的Wi-Fi热点（该热点不需要密码），打开手机设置点击即可连接该Wi-Fi热点，如下图所示：热点名称是`Xizaozhi-7E2D`。
...
在命名的智能体中点击`设备管理`进入添加设备页面。

![](./images/user_guide/img_009.png)

在添加设备页面中，点击在`新增`按钮，然后在弹出的窗口的输入框中填入设备显示或者播报的验证码，最后点击确定即可完成配对。

![](./images/user_guide/img_010.png)
...
![](./images/user_guide/img_011.png)

在角色配置界面，可以根据自己的需要进行配置定制，如下图所示：

![](./images/user_guide/img_012.png)
...
短按一下开关机键，在启动时顶部状态栏显示`扫描Wi-Fi...`时马上按一下`手动打断语音输入按键`，即可进入重新配网模式。
...
![](./images/user_guide/img_014.png)

![](./images/user_guide/img_015.png)
